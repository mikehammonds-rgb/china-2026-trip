const CACHE='china-2026-v5';
const ASSETS=['./','./index.html','./manifest.webmanifest','./spectacle.css','./dynamic.js'];
...
self.addEventListener('fetch',e=>{
  ...
  if(e.request.mode==='navigate'){
    e.respondWith(fetch(e.request).then(async r=>{
      ...
      if(!html.includes('dynamic.js')) html=html.replace('</body>','<script src="./dynamic.js?v=5"></script></body>');
